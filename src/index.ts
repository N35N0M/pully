...
const main = () => {
	...
	const pullyOptions: PullyOptions = {
		...
		PULLY_REVIEW_STATUS_ON_NEW_LINE: core.getInput("PULLY_REVIEW_STATUS_ON_NEW_LINE") !== "",
		PULLY_HIDE_REVIEWS_WHEN_PR_CLOSED: core.getInput("PULLY_HIDE_REVIEWS_WHEN_PR_CLOSED") !== "",
	}
